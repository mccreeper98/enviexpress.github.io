    ...
    <div style="margin-left: 235px; margin-right: 5%;">
      ...
      <div class="row" style="margin-left: 8%;">
        <div class="col s12 m6 l3">
          <h4>
            Paqueterias para el C.P <?php echo $cp;?>
          </h4>
        </div>
      ...
      <br>
     <p style="margin-left: 8%; font-size: 1.4rem"></p>
      <div style="margin-left: 8%;">
        <table class="striped z-depth-3" style="background-color: #fff;">
          <thead>
            <tr>
              <th class="center"><b style="margin-left: 5%;">Paqueteria</b></th>
              <th class="center"><b>Cobertura Terrestre</b></th>
              <th class="center"><b>Cobertura Express</b></th>
              <th class="center"><b>Zona Extendida</b></th>
              <th class="center"><b>Tipo de Zona</b></th>
            </tr>
          </thead>
          ...
          <tbody id="tb">
            ...
            <?php 
               ...
               $obtPaq = mysqli_query($connect, "SELECT disponibilidad.terrestre, disponibilidad.express, disponibilidad.extendida, disponibilidad.tipo, paqueterias.nombre FROM disponibilidad INNER JOIN paqueterias ON paqueterias.idPaqueteria = disponibilidad.idPaqueteria WHERE idZona = $cp");

               while ($paq = mysqli_fetch_array($obtPaq)) {
                 ?>
            <tr>
              <td class="center"><?php echo $paq['nombre'] ?></td>
              <td class="center"><?php echo $paq['terrestre']; ?></td>
              <td class="center"><?php echo $paq['express']; ?></td>
              <td class="center"><?php echo $paq['extendida']; ?></td>
              <td class="center"><?php echo $paq['tipo']; ?></td>
            </tr>
            <?php
               }
